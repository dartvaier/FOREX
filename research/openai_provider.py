...
class OpenAIProvider(LLMProvider):
 ...
 def propose(self,context):
  schema={"type":"object","additionalProperties":False,"required":["title","thesis","expected_mechanism","falsification_criteria","assumptions","tags","parameters"],"properties":{"title":{"type":"string"},"thesis":{"type":"string"},"expected_mechanism":{"type":"string"},"falsification_criteria":{"type":"array","items":{"type":"string"}},"assumptions":{"type":"array","items":{"type":"string"}},"tags":{"type":"array","items":{"type":"string"}},"parameters":{"type":"object","additionalProperties":False,"required":["fast_period","slow_period"],"properties":{"fast_period":{"type":"integer"},"slow_period":{"type":"integer"}}}}}
  raw=self._request(json.dumps(context,default=str),schema)
  try: return HypothesisProposal(raw["title"],raw["thesis"],raw["expected_mechanism"],StrategySpec(RegisteredStrategy.EMA_CROSSOVER,"EURUSD","H1",raw["parameters"]),tuple(raw["falsification_criteria"]),tuple(raw["assumptions"]),tuple(raw["tags"]))
